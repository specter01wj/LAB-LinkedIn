...
function estimateTotal(event) {
	...
	var itemBball = parseInt(document.getElementById('txt-q-bball')
							 .value, 10) || 0,
		itemJersey = parseInt(document.getElementById('txt-q-jersey')
							 .value, 10) || 0,
		itemPower = parseInt(document.getElementById('txt-q-power')
							 .value, 10) || 0,
		itemWater = parseInt(document.getElementById('txt-q-water')
							 .value, 10) || 0,
	...
	var totalQty = itemBball + itemJersey + itemPower + itemWater,
		...
		taxFactor = 1,
		estimate,
		totalItemPrice = (90 * itemBball) + (25 * itemJersey) +
						 (30 * itemPower) + (4 * itemWater);
